...
void WebServer::handle_index_request(AsyncWebServerRequest *request) {
  ...
  stream->print(F("<p>KAUF Bulb by <a href=\"https://kaufha.com\" target=\"_blank\" rel=\"noopener noreferrer\">Kaufman Home Automation</a></p>"));
  stream->print(F("<p>Firmware made using <a href=\"https://esphome.io\" target=\"_blank\" rel=\"noopener noreferrer\">ESPHome</a></p>"));
  stream->print(F("<p>KAUF Bulb firmware version 1.4, ESPHome version 1.22.0-dev</p>"));
